...
public class CannyEdgeDetector {
	...
	private final static String TAG = "CannyEdgeDetector";
	// statics
	...
	public void process() {
		Log.d(TAG, "Canny start");
		width = sourceImage.getWidth();
		height = sourceImage.getHeight();
		picsize = width * height;
		initArrays();
		
		Log.d(TAG, "Canny readLuminance");
		
		readLuminance();
		
		Log.d(TAG, "Canny normalise");
		
		if (contrastNormalized) normalizeContrast();
		
		Log.d(TAG, "Canny compute gradients");
		...
		Log.d(TAG, "Canny hysteresis");
	
		performHysteresis(low, high);

		Log.d(TAG, "Canny threshold");
			
		thresholdEdges();

		Log.d(TAG, "Canny write");
